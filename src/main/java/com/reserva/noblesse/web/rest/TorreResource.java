...
public class TorreResource {
     ...
     */
    @PostMapping("/torres")
    public ResponseEntity<Torre> createTorre(@Valid @RequestBody Torre torre) throws URISyntaxException {
    ...
    public ResponseEntity<Torre> updateTorre(@PathVariable(value = "id", required = false) final Long id, @Valid @RequestBody Torre torre)
    ...
    public ResponseEntity<Torre> partialUpdateTorre(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Torre torre
    ) throws URISyntaxException {
        ...
        Optional<Torre> result = torreRepository
            ...
            .map(
                existingTorre -> {
                    if (torre.getNome() != null) {
                        existingTorre.setNome(torre.getNome());
                    }
     ...
     */
    @GetMapping("/torres")
    public ResponseEntity<List<Torre>> getAllTorres(Pageable pageable) {
        log.debug("REST request to get a page of Torres");
        Page<Torre> page = torreRepository.findAll(pageable);
