    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('reservaNoblesseApp.reserva.aprovado')" for="reserva-aprovado">Aprovado</label>
            <input
              type="checkbox"
              class="form-check"
              name="aprovado"
              id="reserva-aprovado"
              data-cy="aprovado"
              :class="{ valid: !$v.reserva.aprovado.$invalid, invalid: $v.reserva.aprovado.$invalid }"
              v-model="$v.reserva.aprovado.$model"
            />
          </div>
          <div class="form-group">
