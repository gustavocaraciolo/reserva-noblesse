...
class TorreResourceIT {
    ...
    public static Torre createEntity(EntityManager em) {
        Torre torre = new Torre().numero(DEFAULT_NUMERO);
        return torre;
    }
    ...
    public static Torre createUpdatedEntity(EntityManager em) {
        Torre torre = new Torre().numero(UPDATED_NUMERO);
        return torre;
    }
    ...
    void createTorre() throws Exception {
        ...
        assertThat(testTorre.getNumero()).isEqualTo(DEFAULT_NUMERO);
    }
    ...
    void putNewTorre() throws Exception {
        ...
        updatedTorre.numero(UPDATED_NUMERO);
        ...
        Torre testTorre = torreList.get(torreList.size() - 1);
        assertThat(testTorre.getNumero()).isEqualTo(UPDATED_NUMERO);
    }
    ...
    void fullUpdateTorreWithPatch() throws Exception {
        ...
        partialUpdatedTorre.numero(UPDATED_NUMERO);
