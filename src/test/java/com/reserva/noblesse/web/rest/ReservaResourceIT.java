...
class ReservaResourceIT {
    ...
    public static Reserva createEntity(EntityManager em) {
        Reserva reserva = new Reserva().dataHora(DEFAULT_DATA_HORA).notas(DEFAULT_NOTAS).aprovado(DEFAULT_APROVADO);
        return reserva;
    }
    ...
    public static Reserva createUpdatedEntity(EntityManager em) {
        Reserva reserva = new Reserva().dataHora(UPDATED_DATA_HORA).notas(UPDATED_NOTAS).aprovado(UPDATED_APROVADO);
        return reserva;
    }
    ...
    void createReserva() throws Exception {
        ...
        assertThat(testReserva.getAprovado()).isEqualTo(DEFAULT_APROVADO);
    }
    ...
    void putNewReserva() throws Exception {
        ...
        updatedReserva.dataHora(UPDATED_DATA_HORA).notas(UPDATED_NOTAS).aprovado(UPDATED_APROVADO);
        ...
        assertThat(testReserva.getAprovado()).isEqualTo(UPDATED_APROVADO);
    }
    ...
    void partialUpdateReservaWithPatch() throws Exception {
        ...
        partialUpdatedReserva.dataHora(UPDATED_DATA_HORA).notas(UPDATED_NOTAS).aprovado(UPDATED_APROVADO);
