...
describe('Service Tests', () => {
  describe('Reserva Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Reserva', async () => {
      ...
      it('should not update a Reserva', async () => {
      ...
      it('should not partial update a Reserva', async () => {
      ...
      it('should not return a list of Reserva', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Reserva', async () => {
